...
import { slides, MAX_INTERESTS } from './constants'
...
function App() {
  ...
  const handleQuizSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log('Extracted values - salary:', data?.salary, 'growth_potential:', data?.growth_potential, 'industry_sector:', data?.industry_sector)
